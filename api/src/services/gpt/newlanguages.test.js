...
describe('consistent translation of simple code', () => {
  it('Go code poroperly translated and recognized', async () => {
  ...
  it('R code poroperly translated and recognized', async () => {
  ...
  it('Rust code poroperly translated and recognized', async () => {
