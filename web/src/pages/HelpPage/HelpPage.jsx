  ...
  const [faqs, setfaqs] = useState([
    {
      ...
      answer: 'Rosetta Code is a code translation application that translates code written in one language to another with the click of a button!',
      open: false
    },
    {
    ...
    },
    {
      ...
      answer: 'Currently the languages we support are: C, C++, Java, PHP, PYthon, and SQL. We plan on adding more languages as time goes on',
      open: false
    },
    {
      question: 'How much does it cost to use Rosetta Code?',
      answer: 'Rosetta Code is absolutely free! *terms and conditions may apply',
      open: false
    },
    {
    ...
    },
    {
      ...
      answer: 'it depends on the size of the file you are trying to convert. If its a small file it should only take a few seconds. As for larger files it may vary',
      open: false
    }
  ]);
      ...
      <div  className="min-h-screen bg-primary ">
        ...
        <div className="flex basis-1/4 flex-row space-x-10 p-5">
          <div style={{
            ...
            <img classname="justify-center" src="images/Python_logo_51.svg.png" alt="Python" style={{width: '150px', margin: 'auto'}} />
            </a>
